[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=20028243)
...
```
In main two servers run with each thread and, if I type anything, the server stops with stop and interrrupt methods of socket class.
```
...
- Can create using many instances
-Change the content between html tags
- We can create test many using with different ports.
```
